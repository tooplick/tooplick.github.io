...
hero:
  name: "QQ music api"
  tagline: Open Source · Learning · Sharing
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - icon: 🤖
    title: Nekro QQ Music Plugin
    details: QQ Music plugin for Nekro Agent framework, let AI play music for you.
    link: /en/nekro-order-qqmusic/
  - icon: 📥
